...
const priorityConfig = {
  high: { color: "#DC143C", label: "Critical", glow: "#DC143C40" },
  medium: { color: "#FFD700", label: "Important", glow: "#FFD70040" },
  low: { color: "#32CD32", label: "Minor", glow: "#32CD3240" },
};
      ...
      <div className="relative z-10 p-5">
        ...
        <div className="text-center mb-4">
          <h4 
            ...
            style={{ 
              color: '#F4E4BC',
              textShadow: '0 0 6px #D4AF3750, 0 1px 2px #00000080',
              fontFamily: 'serif'
            }}
          >
            {task.title}
        ...
        <div className="flex justify-center mb-4">
          <div 
            className="inline-flex items-center gap-2 px-4 py-2 rounded-full text-xs relative"
            style={{ 
              background: `linear-gradient(135deg, ${priorityInfo.color}15, ${priorityInfo.color}25)`,
              color: priorityInfo.color,
              border: `2px solid ${priorityInfo.color}60`,
              boxShadow: `0 0 8px ${priorityInfo.glow}, inset 0 1px 0 ${priorityInfo.color}20`,
        ...
        <div className="space-y-3 mb-4">
          ...
          <div className="grid grid-cols-2 gap-3 text-xs">
            ...
            >
              ...
              <div>
                <p style={{ color: '#C9A876' }}>Due Date</p>
                <p style={{ color: '#F4E4BC' }}>{task.dueDate}</p>
              </div>
            </div>
            <div 
              className="flex items-center gap-2 p-2 rounded"
            ...
            >
              <User size={12} style={{ color: '#8B3F8B' }} />
              <div>
                <p style={{ color: '#C9A876' }}>Mystic</p>
                <p style={{ color: '#F4E4BC' }}>{task.assignee}</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="flex flex-wrap gap-2 justify-center">
          {task.tags.map((tag, index) => (
            <div 
              key={index}
              className="flex items-center gap-1 px-3 py-1 rounded-full text-xs relative"
              style={{ 
                background: 'linear-gradient(135deg, #3D2A2A 0%, #4A3131 100%)',
                color: '#C9A876',
    ...
    >
        ...
        <div className="flex items-center gap-4 mb-6">
          ...
          <div className="flex-1">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-sm">
              ...
              >
                <span style={{ color: '#C9A876' }}>Coven: </span>
                <span style={{ 
                  color: '#F4E4BC',
                  textShadow: '0 1px 2px #00000060'
                }}>{project.teamSize} mystics</span>
              </div>
              <div 
                className="p-3 rounded border"
                style={{
              ...
              >
                <span style={{ color: '#C9A876' }}>Rituals: </span>
                <span style={{ 
                  color: '#F4E4BC',
                  textShadow: '0 1px 2px #00000060'
                }}>{project.tasksCompleted}/{project.totalTasks}</span>
              </div>
            </div>
          </div>
        </div>
      ...
      <main className="max-w-7xl mx-auto relative z-10">
        <div className="text-center mb-8">
          ...
          >
            Sacred Ritual Tasks ({project.tasks.length})
          </h2>
          <div 
